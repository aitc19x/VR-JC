...
public class SetScene : MonoBehaviour
{
    ...
    //The String should come from the menu scene. After user choooses which scene he or she wants to play, the menu scene should set the value of String photo, which is the file name of the panorama photo, using PlayerPrefs.SetString
    void Start()
    {
